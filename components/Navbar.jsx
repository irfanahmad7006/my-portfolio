    ...
    return (
        <>
            ...
            <nav className={`w-full fixed px-5 lg:px-8 xl:px-[8%] py-4 flex item-center justify-between z-50 
                ${isScroll ? "bg-white bg-opacity-50 backdrop-blur-lg shadow-sm dark:bg-darkTheme dark:sha/20" : ""}`}>
                <a href="#top">
                ...
                <div className='flex items-center gap-4'>
                    <button onClick={() => setDarkMode(preVal => !preVal)}>
                        <Image src={isDarkMode ? assets.sun_icon : assets.moon_icon} alt='' className='w-6' />
                    </button>
                    <a href=" #contact" className='hidden lg:flex place-items-center gap-3 px-10 py-2.5 
                ...
                top-0 bottom-0 w-64 z-50 h-screen bg-rose-50 transition duration-500 dark:bg-darkHover dark:text-white'>
                    ...
                    <li>
                        <a className='font-Ovo' onClick={closeMenu} href="#work">Work</a>
                    </li>
                    <li>
