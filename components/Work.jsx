...
const Work = () => {
    return (
        <div id='work' className='w-full px-[12%] py-10 scroll-mt-20'>
            ...
            <p className='text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo'>Welcome to my Test/Web Development
                portfolio! Explore a collection of projects showcasing my expertise in automation test/front end develpment.
            </p>
            ...
            border-gray-700 rounded-full py-3 px-10 mx-auto my-20 hover:bg-lightHover duration-500'>Show more
                <Image alt='Right arrow' src={assets.right_arrow_bold} 
            className='w-4'/>
            </a>
        </div>
    )
